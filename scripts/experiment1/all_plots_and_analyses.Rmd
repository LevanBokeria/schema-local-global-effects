...
ggsave(filename = 'lr3_no_outlier.png', plot = p, path = './results/experiment1/plots/', width = 5, height = 3, device='png', dpi=300)
...
ggsave(filename = 'lr3_near_far_barplot.png', plot = p, path = './results/experiment1/plots/', width = 10, height = 3, device='png', dpi=300)
